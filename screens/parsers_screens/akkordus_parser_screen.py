...
"""
Экран управления парсером Akkordus.Ru - переведён на BaseParserScreen
"""
...
class AkkordusParserScreen(BaseParserScreen):
    def __init__(self, **kwargs):
        ...
        self.load_icon()
        self.init_ui()
        logger.info('Экран Akkordus парсера создан (BaseParserScreen)')
    ...
    def init_ui(self):
        ...
        title_label = MDLabel(
            text="AKKORDUS ПАРСЕР", font_size=sp(22), halign="center",
            bold=True, theme_text_color="Custom", text_color=[0.7, 0.4, 0.8, 1]
        )
        subtitle_label = MDLabel(
            text="загрузка аккордов с akkordus.ru", font_size=sp(11),
