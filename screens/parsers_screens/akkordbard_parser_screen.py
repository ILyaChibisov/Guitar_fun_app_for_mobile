...
"""
Экран управления парсером AkkordBard.ru - выбор букв A-Я
"""
...
# Буквы для AkkordBard (порядок с главной страницы)
AKKORDBARD_LETTERS = [
...
class AkkordBardLetterSelector(ButtonBehavior, BoxLayout):
    ...
    def _create_popup(self):
        ...
        header_title = Label(text="ВЫБЕРИТЕ БУКВУ (AKKORDBARD)", font_size=sp(16), color=[1, 1, 1, 1],
...
class AkkordBardParserScreen(MDScreen):
    def __init__(self, **kwargs):
        ...
        self.load_icon()
        self.init_ui()
        logger.info('Экран AkkordBard парсера создан')
    ...
    def init_ui(self):
        ...
        title_label = MDLabel(text="AKKORDBARD ПАРСЕР", font_size=sp(22), halign="center", bold=True,
                              theme_text_color="Custom", text_color=[0.5, 0.7, 0.9, 1])
        subtitle_label = MDLabel(text="загрузка аккордов с akkordbard.ru", font_size=sp(11), halign="center",
        ...
        self.letter_label = MDLabel(text="Текущая буква: --", font_size=sp(13), halign="center",
    ...
    def _fetch_status(self):
        try:
            ...
            if result and result.get('success'):
                ...
                current_letter_name = AKKORDBARD_LETTERS[current_letter] if current_letter < len(
                    AKKORDBARD_LETTERS) else '?'
